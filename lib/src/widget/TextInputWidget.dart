...
//    eye = !(widget.inputType == InputType.password);
          ...
          child: CustomCheckBox(
            ...
            padding: widget.eyePadding ??
                EdgeInsets.symmetric(
                    vertical: BaseUtils.getWidth(6),
                    horizontal: BaseUtils.getHeight(10)),
  ...
  List<TextInputFormatter> inputTextType() {
    switch (widget.inputTextType) {
      ...
      case InputTextType.mobilePhoneNumber:
        return [
          WhitelistingTextInputFormatter(
              RegExp(WayConstant.regExpMobilePhoneNumber)),
        ];
