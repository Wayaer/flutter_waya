## [1.11.0]
  * change [SliverAutoAppBar] to [ExtendSliverAppBar] 
  * change [FlexibleSpaceAutoBar] to [ExtendFlexibleSpaceBar] 
  * change [SliverAutoPersistentHeader] to [ExtendSliverPersistentHeader] 
  * change [ScrollViewAuto] to [ExtendScrollView] 
  * change [OverlayEntryAuto] to [ExtendOverlayEntry] 
